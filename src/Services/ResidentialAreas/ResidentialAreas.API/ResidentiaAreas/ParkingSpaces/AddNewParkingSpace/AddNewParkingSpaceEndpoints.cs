...
namespace ResidentialAreas.API.ResidentiaAreas.ParkingSpaces.AddNewParkingSpace
{
    ...
    public class AddNewParkingSpaceEndpoints : ICarterModule
    {
        ...
        {
            app.MapPost("/residential-areas/parking-spaces/add", async (AddNewParkingSpaceRequest request, ISender sender, [FromServices] IValidator<AddNewParkingSpaceRequest> validator, CancellationToken cancellationToken, ILogger<AddNewParkingSpaceEndpoints> logger) =>
            {
