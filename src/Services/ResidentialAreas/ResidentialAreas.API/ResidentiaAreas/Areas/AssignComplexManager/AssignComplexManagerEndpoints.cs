...
namespace ResidentialAreas.API.ResidentiaAreas.Areas.AssignComplexManager
{
    ...
    public class AssignComplexManagerEndpoints : ICarterModule
    {
        ...
        private static async Task<IResult> HandleAssignComplexManager(AssignComplexManagerRequest request, ISender sender, IValidator<AssignComplexManagerRequest> validator)
        {
